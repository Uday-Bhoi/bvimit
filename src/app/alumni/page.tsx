...
export default function AlumniPage() {
  ...
  const notableAlumni = alumniData;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <motion.div {...fadeIn}>
              ...
              <p className="text-gray-400 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed mb-12">
                A global community of 2500+ professionals driving innovation in
                the technology sector. Once a student at BVIMIT, always a member
                of the Bharati Vidyapeeth family.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <motion.div {...fadeIn}>
                <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tighter mb-8 leading-tight">
                  Cultivating a{" "}
                  <span className="text-primary italic">Life-Long</span>{" "}
                  Connection
                </h2>
                <div className="space-y-6 text-muted-foreground font-medium leading-relaxed text-lg">
                  <p>
                    Our graduates are our greatest ambassadors. The BVIMIT
                    Alumni Association fosters mutual growth by creating a
                    vibrant platform where veterans mentor new-age innovators.
                  </p>
                  <p>
                    Through organized reunions, industrial workshops, and
                    executive lectures, we ensure that our legacy continues to
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeIn} className="text-center mb-24">
              <h2 className="text-4xl font-black text-foreground tracking-tighter mb-4">
                Notable <span className="text-primary italic">Ambassadors</span>
              </h2>
              <p className="text-muted-foreground font-black uppercase tracking-[0.3em] text-[10px]">
                Alumni Excellence in Global Organizations
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {notableAlumni.map((alumnus, i) => (
                ...
                >
                  ...
                  <div className="p-8">
                    <span className="text-primary font-black uppercase tracking-widest text-[9px] mb-2 inline-block h-4 overflow-hidden">
                      {alumnus.experience}
                    </span>
                    <h3 className="text-xl font-black text-foreground mb-1 tracking-tight">
                      {alumnus.name}
                    </h3>
                    <p className="text-muted-foreground font-bold text-xs uppercase tracking-wide mb-6">
                      {alumnus.designation}
                    </p>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter relative z-10">
              Stay <span className="text-primary italic">Connected</span> with
              Us
            </h2>
            <p className="text-gray-500 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-16 relative z-10">
              Update your professional profile and receive updates on alumni
              meets, exclusive job opportunities, and institute milestones.
            </p>
