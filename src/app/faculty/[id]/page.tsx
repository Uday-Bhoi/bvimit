      ...
      <SiteShell>
        <main className="min-h-[60vh] flex flex-col items-center justify-center text-center p-8">
          ...
          <p className="text-muted-foreground font-medium mb-10">
            The profile you are looking for has been moved or updated.
          </p>
          <Link
            href="/faculty"
            className="px-10 py-5 bg-primary text-white font-black uppercase text-xs tracking-widest rounded-full shadow-2xl"
          >
        ...
        <section className="relative py-24 md:py-32 bg-[#111827] overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <motion.div {...fadeIn} className="inline-block mb-10">
              <Link
                href="/faculty"
                className="flex items-center gap-3 text-primary font-black uppercase tracking-[0.2em] text-[10px] hover:translate-x-2 transition-transform"
              >
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-12 mt-4 border-y border-white/10 py-10 w-full lg:w-auto px-6 lg:px-0">
                  <div className="flex flex-col items-center lg:items-start">
                    <span className="text-primary font-black text-[10px] uppercase tracking-widest mb-2 opacity-60">
                      Academic Rank
                    </span>
                ...
                <div className="mt-12 flex flex-wrap gap-6 pt-4">
                  <a
                    ...
                    className="px-10 py-5 bg-primary text-white font-black uppercase text-[10px] tracking-[0.25em] rounded-full shadow-2xl hover:scale-105 transition-all flex items-center gap-3"
                  >
                    <Download className="w-4 h-4" /> View Formal Resume
                  </a>
                  <a
                    href={`mailto:${member.email}`}
                    className="px-10 py-5 bg-white/10 backdrop-blur-xl border border-white/20 text-white font-black uppercase text-[10px] tracking-[0.25em] rounded-full hover:bg-white/20 transition-all flex items-center gap-3"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-4 space-y-12">
              ...
              <motion.div
                ...
                className="bg-card p-10 rounded-[3rem] border border-border/50 shadow-sm relative overflow-hidden group"
              >
              ...
              >
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-muted-foreground text-sm font-medium leading-relaxed italic border-l-2 border-primary/20 pl-4">
                    Committed to delivering world-class IT education and
            ...
            <div className="lg:col-span-8 space-y-12">
              <motion.div
                ...
                className="bg-card p-12 rounded-[3.5rem] border border-border/50 shadow-sm"
              >
                ...
                <div className="flex flex-wrap gap-4">
                  {member.expertise.split(",").map((skill, i) => (
                    <div
                      key={i}
                      className="px-6 py-3 bg-muted/60 text-muted-foreground text-[11px] font-black uppercase tracking-[0.1em] rounded-full border border-border/50 hover:bg-primary/10 hover:text-primary hover:border-primary/30 transition-all cursor-default"
                    >
                      {skill.trim()}
                    </div>
                  ))}
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 rounded-[2.5rem] border border-border/50 hover:border-primary/20 transition-all group">
                    ...
                    <p className="text-muted-foreground text-sm font-medium">
                      Available in the official faculty research repository.
                      Covers advanced computing trends.
                    </p>
                  </div>
                  <div className="p-8 rounded-[2.5rem] border border-border/50 hover:border-primary/20 transition-all group">
                    ...
                    <p className="text-muted-foreground text-sm font-medium">
                      Leading consultancy projects in AI governance and
              ...
              <motion.div
                ...
                className="bg-primary/5 p-12 rounded-[3.5rem] border border-primary/20 shadow-xl overflow-hidden relative group"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                  {[
                    ...
                    <div
                      key={i}
                      className="p-6 bg-white/80 dark:bg-black/20 backdrop-blur rounded-2xl border border-border/50"
                    >
