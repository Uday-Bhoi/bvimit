      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <motion.div {...fadeIn} className="max-w-3xl">
              ...
              <p className="text-gray-400 text-lg md:text-xl font-medium leading-relaxed mb-12 max-w-2xl">
                Bridging the gap between academic brilliance and industrial
                excellence. Our dedicated cell ensures every student is
                corporate-ready from Day 1.
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-4xl font-black text-foreground mb-1 tracking-tighter">
                    {stat.number}
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <motion.div {...fadeIn}>
                ...
                <h2 className="text-4xl md:text-5xl font-black text-foreground tracking-tighter mb-8 leading-tight">
                  Empowering{" "}
                  <span className="text-primary italic">Careers</span> Through
                  Industrial Synergy
                </h2>
                <div className="space-y-6 text-muted-foreground font-medium leading-relaxed text-lg">
                  <p>
                    Our Training and Placement Cell acts as a strategic bridge
                    between the student community and the corporate world. We go
                    beyond mere recruitment by focusing on long-term
                    employability.
                  </p>
                  <p>
                    BVIMIT has maintained a legacy of excellence, attracting
                    top-tier engineering and consulting firms through our
                    rigorous academic standards and industry-aligned training
                    modules.
                  </p>
                </div>
                ...
                <div className="mt-12 space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-3 font-bold text-foreground text-sm"
                    >
              ...
              >
                ...
                <div className="space-y-6 pt-12">
                  <div className="bg-[#111827] p-8 rounded-[2.5rem] text-white">
                    ...
                    <div className="text-2xl font-black leading-tight">
                      Mock Interview Expert Panels
                    </div>
                  </div>
                  <div className="h-64 rounded-[2.5rem] overflow-hidden shadow-2xl -skew-y-1">
                    <img
                      src="https://harmless-tapir-303.convex.cloud/api/storage/8355377a-f356-4a02-83dd-1cb6b4038f23"
                      alt="Industry"
                      className="w-full h-full object-cover"
                    />
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeIn} className="text-center mb-24">
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-4">
                The Placement <span className="text-primary italic">Cycle</span>
              </h2>
              <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">
                A Systematic Path to Your Dream Job
              </p>
            </motion.div>
            ...
            <div className="space-y-12 max-w-4xl mx-auto">
              {[
                {
                  step: "A",
                  title: "Registration & Profile Mapping",
                  desc: "Students register with the cell and create standardized technical profiles.",
                },
                {
                  step: "B",
                  title: "Pre-Placement Training",
                  desc: "Intensive 4-week bootcamp focusing on aptitude and coding skills.",
                },
                {
                  step: "C",
                  title: "Campus Recruitment Drive",
                  desc: "Companies visit for multi-stage selection: Test → GD → PI.",
                },
                {
                  step: "D",
                  title: "Offer Acceptance & Career Launch",
                  desc: "Final verification and formal joining procedures with recruiters.",
                },
              ].map((item, i) => (
        ...
        <section className="py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeIn} className="text-center mb-24">
              <h2 className="text-4xl font-black text-foreground tracking-tighter mb-4">
                Our Elite <span className="text-primary italic">Network</span>
              </h2>
              <p className="text-muted-foreground font-bold uppercase tracking-widest text-[10px]">
                Where Our Students Excel
              </p>
            </motion.div>
            ...
            <div className="mt-20 p-12 bg-primary/5 rounded-[3rem] border border-primary/10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div>
                <h3 className="text-2xl font-black text-foreground mb-2">
                  Invite BVIMIT for Campus Placement
                </h3>
                <p className="text-muted-foreground font-medium">
                  Join our network of 150+ satisfied hiring partners.
                </p>
              </div>
